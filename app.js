  ...
  res.send(`
    <html>
      ...
      <body style="font-family: sans-serif; padding: 2rem; text-align: center;">
        <h1>Admin Panel</h1>
        <a href="/create-article?password=secret123">➕ Create New Article</a>
        <br/><br/>
...
// === GET: Article Creation Page (Admin Only) ===
...
// === Forms (Signup / Login / Assignment / Contact) ===
